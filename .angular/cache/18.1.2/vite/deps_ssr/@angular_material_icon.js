...
var _MatIconRegistry = class _MatIconRegistry {
  ...
  getSvgIconFromUrl(safeUrl) {
    ...
    if (cachedIcon) {
      return (0, import_rxjs5.of)(cloneSvg(cachedIcon));
    }
  ...
  getNamedSvgIcon(name, namespace = "") {
    ...
    return (0, import_rxjs5.throwError)(getMatIconNameNotFoundError(key));
  }
  ngOnDestroy() {
    this._resolvers = [];
  ...
  _getSvgFromConfig(config) {
    if (config.svgText) {
      return (0, import_rxjs5.of)(cloneSvg(this._svgElementFromConfig(config)));
    } else {
  ...
  _getSvgFromIconSetConfigs(name, iconSetConfigs) {
    ...
    if (namedIcon) {
      return (0, import_rxjs5.of)(namedIcon);
    }
    const iconSetFetchRequests = iconSetConfigs.filter((iconSetConfig) => !iconSetConfig.svgText).map((iconSetConfig) => {
      return this._loadSvgIconSetFromConfig(iconSetConfig).pipe((0, import_operators5.catchError)((err) => {
        ...
        return (0, import_rxjs5.of)(null);
      }));
    });
    return (0, import_rxjs5.forkJoin)(iconSetFetchRequests).pipe((0, import_operators5.map)(() => {
...
var _MatIcon = class _MatIcon {
  ...
  constructor(_elementRef, _iconRegistry, ariaHidden, _location, _errorHandler, defaults) {
    ...
    this._currentIconFetch = import_rxjs5.Subscription.EMPTY;
    if (defaults) {
      if (defaults.color) {
